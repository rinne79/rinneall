    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-lg border border-border-primary bg-secondary/30 p-3 space-y-2">
          {/* Rinne Command Center Vault — always selected */}
          <div className="flex items-center gap-3 p-2">
            ...
            <img src="/command-center-mark.png" alt="Rinne Command Center" className="w-4 h-4 object-contain shrink-0" />
            <span className="text-sm">Rinne Command Center Vault</span>
